...
export default function ParticleAnimation() {
  ...
  return (
    ...
    >
      {/* Grid Background - moved to root container */}
      <div className="fixed inset-0 h-full w-full">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#8884_1px,transparent_1px),linear-gradient(to_bottom,#8884_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#fff4_1px,transparent_1px),linear-gradient(to_bottom,#fff4_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_40%,transparent_100%)]" />
      </div>
